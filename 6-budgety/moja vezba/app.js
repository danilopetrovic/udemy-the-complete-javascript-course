...
var budgetController = (function () {
    ...
    var data = {
        ...
        budget: 0,
        percentage: -1 // -1 represents something that doesn't exists
    };
...
var UIController = (function () {
    ...
    return {
        ...
        //         if (percentages > 0) { //ovo je pogresan uslov zato sto ne moze array da bude veci od 0
        ...
        // MOJE RESENJE! Njegovo resenje ne radi!
        displayPercentages: function (percentages) {
            var fields = document.querySelectorAll(DOMstrings.expensesPercLabel);
            fields.forEach(function (element, index) {
                for (let i = 0; i < percentages.length; i++) {
                    if (i === index) {
                        element.textContent = percentages[i];
                    }
                }
            });
        },
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var setupEventListeners = function () {
        ...
        document.querySelector(DOM.inputBtn).addEventListener('click', ctrlAddItem); // Will be either inc or exp
